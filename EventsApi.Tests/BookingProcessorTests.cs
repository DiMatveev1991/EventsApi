...
public class BookingProcessorTests
{
    ...
    private static (IServiceProvider provider, IEventService events, IBookingStore store, BookingProcessor processor)
        BuildSut()
    {
        ...
        var processor = new BookingProcessor(scopeFactory, NullLogger<BookingProcessor>.Instance);
    ...
    {
        // Arrange
        var (_, events, store, processor) = BuildSut();
    ...
    {
        // Arrange
        var (_, _, store, processor) = BuildSut();
