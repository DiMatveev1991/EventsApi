...
{
	/// <summary>
	/// Доступ к данным событий. Инкапсулирует всю работу с <c>AppDbContext</c>
	/// по сущности <see cref="Event"/>: сервисы работают с событиями только через
	/// этот интерфейс и напрямую к контексту не обращаются.
	/// </summary>
	public interface IEventRepository
	{
		...
		/// <summary>Сохраняет изменения ранее полученного (отслеживаемого) события.</summary>
