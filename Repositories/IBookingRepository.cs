...
{
	/// <summary>
	/// Доступ к данным бронирований. Инкапсулирует всю работу с <c>AppDbContext</c>
	/// по сущности <see cref="Booking"/>. Сервисы и фоновый обработчик работают
	/// с бронями только через этот интерфейс.
	/// </summary>
