...
namespace EventsApi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260810233000_AddUsersAndBookingOwnership")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventsApi.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id").HasColumnType("uuid");
                    b.Property<string>("Login").IsRequired().HasMaxLength(100).HasColumnType("character varying(100)");
                    b.Property<string>("PasswordHash").IsRequired().HasMaxLength(64).HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("EventsApi.Domain.Entities.Event", b => b.Navigation("Bookings"));
            modelBuilder.Entity("EventsApi.Domain.Entities.User", b => b.Navigation("Bookings"));
