	...
	public sealed class EventRepositoryTests : IntegrationTestBase
	{
		...
		public async Task UpdateAsync_persists_changed_fields()
		{
			...
			await using (var ctx = CreateContext())
			{
				...
				stored.StartAt = new DateTime(2030, 5, 5, 9, 0, 0, DateTimeKind.Unspecified);
			...
			await using (var ctx = CreateContext())
			{
				...
				stored.StartAt.Should().Be(new DateTime(2030, 5, 5, 9, 0, 0, DateTimeKind.Unspecified));
			}
		}
		...
		{
			// Arrange
			var early = TestData.Event(title: "Early", startAt: new DateTime(2025, 1, 1, 10, 0, 0, DateTimeKind.Unspecified));
			var middle = TestData.Event(title: "Middle", startAt: new DateTime(2025, 6, 1, 10, 0, 0, DateTimeKind.Unspecified));
			var late = TestData.Event(title: "Late", startAt: new DateTime(2025, 12, 1, 10, 0, 0, DateTimeKind.Unspecified));
		...
		public async Task GetPagedAsync_filters_by_from_date()
		{
			// Arrange
			await SeedAsync(
				TestData.Event(title: "Past", startAt: new DateTime(2024, 1, 1, 10, 0, 0, DateTimeKind.Unspecified)),
				TestData.Event(title: "Future", startAt: new DateTime(2026, 1, 1, 10, 0, 0, DateTimeKind.Unspecified)));
			var from = new DateTime(2025, 1, 1, 0, 0, 0, DateTimeKind.Unspecified);
		...
		public async Task GetPagedAsync_filters_by_to_date()
		{
			...
			var early = TestData.Event(
				title: "Early",
				startAt: new DateTime(2024, 1, 1, 10, 0, 0, DateTimeKind.Unspecified),
				endAt: new DateTime(2024, 1, 1, 12, 0, 0, DateTimeKind.Unspecified));
			var late = TestData.Event(
				title: "Late",
				startAt: new DateTime(2026, 1, 1, 10, 0, 0, DateTimeKind.Unspecified),
				endAt: new DateTime(2026, 1, 1, 12, 0, 0, DateTimeKind.Unspecified));
			await SeedAsync(early, late);
			var to = new DateTime(2025, 1, 1, 0, 0, 0, DateTimeKind.Unspecified);
		...
		public async Task GetPagedAsync_combines_title_and_date_filters()
		{
			// Arrange
			await SeedAsync(
				TestData.Event(title: "DotNet Early", startAt: new DateTime(2024, 1, 1, 10, 0, 0, DateTimeKind.Unspecified)),
				TestData.Event(title: "DotNet Late", startAt: new DateTime(2026, 1, 1, 10, 0, 0, DateTimeKind.Unspecified)),
				TestData.Event(title: "Java Late", startAt: new DateTime(2026, 1, 1, 10, 0, 0, DateTimeKind.Unspecified)));
			var from = new DateTime(2025, 1, 1, 0, 0, 0, DateTimeKind.Unspecified);
		...
		public async Task GetPagedAsync_applies_pagination_via_skip_and_take()
		{
			...
			var events = Enumerable.Range(1, 5)
				.Select(i => TestData.Event(
					title: $"Event {i}",
					startAt: new DateTime(2025, i, 1, 10, 0, 0, DateTimeKind.Unspecified)))
				.ToArray();
